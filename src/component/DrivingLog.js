...
class DrivingLog extends React.Component {
    ...
    render(){
        return(
            <div>
                {this.state.renderManeuvers ? <div>{this.state.maneuvers.map(man => <Maneuvers maneuverObj={man} key={man.id}/>) }<input type='button' onClick={this.renderManeuvers} value='Return to Driving Log Page' className='driving-log'/></div>:
                <div>
                    ...
                    <div onClick={this.renderManeuvers} className='driving-log-clickable'>
